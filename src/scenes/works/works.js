...
import Nike from '../../assets/media/images/nike.webp'
class works extends Component {
  ...
  showNike = () => this.setState({ openNike: true })
  ...
  closeNike = () => this.setState({ openNike: false })
  ...
  render() {
    const { openAssure, openCores, openMvemjsun, openRevature, openThomas, openWalmart, openNike } = this.state
    return (
      <div>
        <div className='worksGrid'>
          ...
          <Card.Group stackable itemsPerRow={4}>
            <Card
              as='a'
              onClick={this.showNike}
              target='_blank'
              color='blue'
              image={Nike}
              header='Nike'
              meta='Bill of Materials Ecosystem'
              description='Footwear Production and Process'
            />
            <Card
              as='a'
              onClick={this.showAssure}
              target='_blank'
              color='blue'
              image={Assure}
        ...
        {/* ******************************Modals****************************** */}
        <Modal className='container' basic closeIcon size='fullscreen' open={openNike} onClose={this.closeNike}>
          <div className='modal-container'>
            <Modal.Content>
              <div className='row'>
                <div className='column'>
                  <div className='image-container'>
                    <Image className='assureBackground' src={Nike}></Image>
                  </div>
                  ...
                  <List divided inverted relaxed className='list' verticalAlign='middle' size='medium'>
                    ...
                    <List.Item>
                      <List.Content>
                        ...
                        Vue, Vuex, ElasticSearch, SQL, Node.js
                      </List.Content>
                    </List.Item>
                    <List.Item>
                      <List.Content>
                        <List.Header>Description</List.Header>Senior software engineer on Nike's Bill of Materials ecosystem to provide
                        tooling and infrastucture for production.
                      </List.Content>
                    </List.Item>
                  </List>
                </div>
              ...
              <div className='row'>
                <div className='column'>
                  ...
                  <List divided inverted relaxed className='list' verticalAlign='middle' size='medium'>
                    ...
                    <List.Item>
                      <List.Content>
                        <List.Header>Description</List.Header>Primary designer and software engineer on a software suite called Glassboard
                        by Assure Services. Glassboard is designed to create the first private transaction platform.
                      </List.Content>
                    </List.Item>
                  </List>
                </div>
              ...
              <div className='row'>
                <div className='column'>
                  ...
                  <List divided inverted relaxed className='list' verticalAlign='middle' size='medium'>
                    ...
                    <List.Item>
                      <List.Content>
                        <List.Header>Description</List.Header>Software Engineer for platform to automate International Customs documentation
                        on transactions. Creating Middleware to transfer Inventory data across multiple servers and an error tracking chrome
                        extension for vendors to request assistance.
                      </List.Content>
                    </List.Item>
                  </List>
                </div>
              ...
              <div className='row'>
                <div className='column'>
                  ...
                  <List divided inverted relaxed className='list' verticalAlign='middle' size='medium'>
                    ...
                    <List.Item>
                      <List.Content>
                        <List.Header>Description</List.Header>Designed and created a Single Sign On Service for Revature and their employees
                        within their internal platform.
                      </List.Content>
                    </List.Item>
                  </List>
                </div>
              ...
              <div className='row'>
                <div className='column'>
                  ...
                  <List divided inverted relaxed className='list' verticalAlign='middle' size='medium'>
                    ...
                    <List.Item>
                      <List.Content>
                        <List.Header>Description</List.Header>A personal project I was apart of that aimed to create a 3D Renditon of the
                        solar system utilizing Motion Tracking. The project was aimed to build a Interactive installation for the Museum of
                ...
                <div className='column'>
                  ...
                  <List divided inverted relaxed className='list' verticalAlign='middle' size='medium'>
                    ...
                    <List.Item>
                      <List.Content>
                        <List.Header>Description</List.Header>
                        This was the first renditon of an ongoing project and study to create a functional robot with the lowest cost
                        possible.
                      </List.Content>
                    </List.Item>
                  </List>
        ...
        <Responsive {...Responsive.onlyMobile}>
          <Modal className='container' basic closeIcon size='small' open={openNike} onClose={this.closeNike}>
            <div className='modal-container'>
              <Modal.Content>
                <div className='rowMobile'>
                  <div className='columnMobile'>
                    ...
                    <Button onClick={this.closeNike}>Return</Button>
                  </div>
                </div>
              </Modal.Content>
            </div>
                ...
                <div className='rowMobile'>
                  <div className='columnMobile'>
                    ...
                    <List divided inverted relaxed className='list' verticalAlign='middle' size='medium'>
                      ...
                      <List.Item>
                        <List.Content>
                          <List.Header>Description</List.Header>Software engineer for platform to automate International Customs
                          documentation on transactions. Created Middleware to transfer Inventory data across multiple servers and an error
                          tracking chrome extension for vendors to request assistance.
                        </List.Content>
                      </List.Item>
                    </List>
                ...
                <div className='rowMobile'>
                  <div className='columnMobile'>
                    ...
                    <List divided inverted relaxed className='list' verticalAlign='middle' size='medium'>
                      ...
                      <List.Item>
                        <List.Content>
                          <List.Header>Description</List.Header>Designed and created a Single Sign On Service for Revature and their
                          employees within their internal platform.
                        </List.Content>
                      </List.Item>
                    </List>
                  ...
                  <div className='columnMobile'>
                    ...
                    <List divided inverted relaxed className='list' verticalAlign='middle' size='medium'>
                      ...
                      <List.Item>
                        <List.Content>
                          <List.Header>Description</List.Header>A personal project I was apart of that aimed to create a 3D Renditon of the
                          solar system utilizing Motion Tracking. The project was aimed to build a Interactive installation for the Museum
